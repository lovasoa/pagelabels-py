...
usage: pagelabels [-h] [--outfile out.pdf] [--delete | --update]
                  [--startpage STARTPAGE]
                  [--type {arabic,roman lowercase,roman uppercase,letters lowercase,letters uppercase,no numbering}]
...
optional arguments:
  ...
  --type {arabic,roman lowercase,roman uppercase,letters lowercase,letters uppercase,no numbering}, -t {arabic,roman lowercase,roman uppercase,letters lowercase,letters uppercase,no numbering}
                        type of numbers: arabic = 1, 2, 3, roman = i, ii, iii,
                        iv, letters = a, b, c, no numbering =  (number is empty)
